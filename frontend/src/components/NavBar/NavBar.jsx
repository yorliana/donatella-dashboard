...
export default function NavBar() {
  ...
  <header className="bg-[#5a3d2b] text-white shadow-md w-full h-[90px]">
    <div className="flex items-center justify-between px-5 py-3">
      ...
      <div className="flex items-center space-x-3">
        <img 
          src={img}
          alt="Donatella Logo"
          className="h-30 w-[30px]object-contain pl-[50px]"
      ...
      <div className="flex items-center space-x-6">
        {/* Botón Ordenar ahora */}
       <button
      className="border border-white rounded-lg px-4 py-2 hover:bg-white hover:text-[#513120] transition"
      onClick={() => navigate("/formulario")} // <--- página a la que quieres ir
    >
      Ordenar ahora
    </button>
