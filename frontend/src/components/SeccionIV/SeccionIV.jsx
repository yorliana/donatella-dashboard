...
export default function SeccionIV() {
  return (
    ...
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden bg-white">
      ...
      {/* Imagen de las cajas */}
      <div className="relative pl-20 z-10 mt-10 flex justify-center">
        <img
          src={imgCajas}
          alt="Cajas Amor y Amistad Donatella"
          className="w-[600px] md:w-[720px] lg:w-[900px] object-contain"
        />
        <span className="font-bold text-[#5a3d2b]  top-20">Edicion especial *</span>
      </div>
